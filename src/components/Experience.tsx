...
const Experience = () => {
  ...
  // Removed animateSkills as it was unused
  ...
  // Trigger skill animation when skills tab is opened (removed animateSkills logic as it was unused)
  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      organization: "ONRTECH",
      period: "Fev 2025 - Present",
      location: "Remote / France",
      description: "Developed an AI-powered mobile app for personalized nutrition, implementing hybrid recommendation systems and a LangChain chatbot backed by ChromaDB for dietary guidance.",
      skills: ["Python", "LangChain", "ChromaDB", "Machine Learning", "NLP"],
      highlights: [
        "Built data pipeline for real-time product updates via web scraping",
        "Integrated generative AI, embeddings, and RAG for context-aware interactions",
        "Enhanced personalized nutrition recommendations using LLMs"
      ]
    },
    {
      id: 2,
      title: "Heart Disease Predictor (ML)",
      description: "Built a machine learning model to predict heart disease using factors like age, sleep hours, BMI, smoking, and alcohol consumption, achieving 90% accuracy by comparing 8 classification algorithms.",
      technologies: ["Python", "Scikit-learn", "ML Algorithms", "Data Analysis"]
    },
    {
      id: 3,
      title: "Movie Rating System (Big Data - Hadoop)",
      description: "Designed and optimized a scalable system to efficiently process over 1 million user votes for accurate film evaluations using Hadoop big data technologies.",
      technologies: ["Hadoop", "Big Data", "MapReduce", "Data Engineering"]
    },
    {
      id: 4,
      title: "Attacks Prediction in Healthcare Devices (Deep Learning)",
      description: "Developed an ANN-based deep learning model to detect and mitigate security threats in Internet of Medical Things (IoMT) environments, achieving 99% accuracy.",
      technologies: ["Deep Learning", "Artificial Neural Networks", "IoMT Security", "Python"]
    }
  ];
  ...
  const certifications: Certification[] = [
    {
      ...
      issuer: "AWS Academy",
      issued: "Jan 2025",
      credentialUrl: "https://www.credly.com/badges/d7381342-1fb3-419d-b880-de8641c35e34/linked_in_profile",
      credentialId: "",
      skills: ["AWS Architecture", "AWS Cloud", "AWS Storage", "Networking", "Databases"]
    },
    {
      title: "Python for Data Science, AI & Development",
      issuer: "IBM",
      issued: "Aug 2024",
      credentialUrl: "https://coursera.org/share/85cde783b96d2cab3ac6bce42b6698a8",
      credentialId: "",
    ...
    },
    {
      ...
      issued: "Mar 2024",
      credentialUrl: "https://coursera.org/share/8c88a20cc5785d1c947524b073ab9756",
      credentialId: "",
  ...
  const leadership: LeadershipItem[] = [
    {
      title: "Member",
      organization: "ATIA | Tunisian Association for Artificial Intelligence",
      period: "Sep 2023 - Present",
      description: "Active participant in the Tunisian AI community through ATIA and ISIMM Club, engaging in workshops, seminars, and projects focused on advancing artificial intelligence research and applications."
    },
    {
      title: "Member",
      organization: "IEEE ISIMM CIS Student Chapter (Computational Intelligence Society)",
      period: "Jan 2024 - Present",
      description: "Contributing member of the IEEE student chapter focused on computational intelligence. Participate in technical talks, collaborative projects, and networking events to foster knowledge sharing and professional growth."
    }
  ];
                          ...
                          <div className="p-6">
                            ...
                            <div className="flex justify-between items-start mb-4">
                              <div className="flex-1">
                                ...
                                {exp.organization && <p className="text-teal-400 font-medium mb-1">{exp.organization}</p>}
                                ...
                                {(exp.skills || exp.technologies) && (
                                  <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                      {(exp.skills || exp.technologies)?.map((skill, skillIndex) => (
                                        <span
                                          key={skillIndex}
