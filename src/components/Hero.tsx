...
const Hero = () => {
  ...
  const roles = useMemo(() => [ 'AI Engineer','Data Scientist','Developer', 'Problem Solver'], []);
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen py-20">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-400 mb-10 max-w-lg mx-auto">
              Data Scientist & AI Engineer passionate about transforming data into intelligent, impactful solutions.
              Designing and developing AI-powered applications and machine learning models that blend innovation, functionality, and user-focused design.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
              ...
              <a
                href="/images/BelgacemCHAIB_resume.pdf"
                download
            ...
            <div className="flex gap-6 mt-12 justify-center">
              <a
                href="https://github.com/bellgacem23"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/belgacemc23/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="mailto:belgacemchaibi23@gmail.com"
